...
@section('content')
    <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <a href="#" class="text-2xl font-bold text-gray-800">Generic Snicker Shop</a>
            ...
            <form class="mt-5 grid gap-6">
                <div class="relative">
                    ...
                    <label
                        ...
                        <div class="ml-5">
                            <span class="mt-2 font-semibold">Pathao Rider</span>
                ...
                <div class="relative">
                    ...
                    <label
                        ...
                        <div class="ml-5">
                            <span class="mt-2 font-semibold">Redex Delivery</span>
                            <p class="text-slate-500 text-sm leading-6">Delivery: 2-4 Days</p>
                        </div>
                    </label>
                </div>
